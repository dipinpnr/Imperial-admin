                              ...
                              <div class="table-responsive">
                                 <table class="table table-borderless">
                                    <tbody class="col-lg-12 col-xl-6 p-0">
                                       ...
                                       <tr>
                                          <td><strong>Payment Mode: </strong> </td> <td>{{ @$order->order_type}}</td>
                                       </tr>
                                       <tr>
                                     ...
                                     <tr>
                                       ...
                                       <td> 
                                        ...
                                        {!! str_replace('*', ' ',@$oredrAddr->name) !!} <br/> {!! str_replace('*', ' ',@$oredrAddr->address)!!}
                                     ...
                                     @endphp
                                      <tr>
                                          <td><strong>Branch: </strong> </td> <td>{{ @$branch->branch_name}}</td>
                                       </tr>
                                       @php
                                     ...
                                     @endphp
                                      ...
                                      <tr>
                                          <td><strong>Delivery Area : </strong> </td> <td>{{ @$da->area_name}}</td>
                                       </tr>

                                       <tr>
                                          <td><strong>Time Slot : </strong> </td> <td>{{ @$ts->day }} {{ ' ' }} {{@$ts->time_start }}-{{ @$ts->time_end }}</td>
                                       </tr>
                               ...
                               <table class="table table-striped table-bordered text-nowrap w-100">
                                 ...
                                 <tbody>
                                    ...
                                    @foreach ($order_items as $order_item)
                                       <tr>
                                          <td>
                                             <img src="{{URL::to('/assets/uploads/products/base_product/base_image/'.@$order_item->product_varient->product_varient_base_image)}}"  width="50" >
                                             <br>
