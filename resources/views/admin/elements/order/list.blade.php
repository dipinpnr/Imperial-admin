                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           @else
                           {!! str_replace('*', ' ', @$order->customerAddress['name']) !!}
                           @endif
                        </td>
                        ...
                        <td>
                           @php
                              ...
                              foreach($itemsArr as $item){
                                 $itemsArrPro =  Mst_branch_product::find(@$item->product_id);
                       ...
                       <a class="btn btn-sm btn-indigo"
                        href="{{url('store/order/invoice/'.Crypt::encryptString($order->order_id))}}">Invoice</a>
                         <a id="genInvoice{{$loop->iteration}}" onclick="hideInvBtn(this.id)" class="btn btn-sm btn-info" href="{{url('store/product_invoice/pdf/'.Crypt::encryptString($order->order_id))}}">Generate Invoice </a>
                        @php
