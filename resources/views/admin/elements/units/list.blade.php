...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
                                ...
                                <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                                    ...
                                    <tbody >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="color:white;" id="statusBtn{{$row->unit_id}}" 
                                                    onclick="changeStatus({{$row->unit_id}})"  
            ...
            @foreach($units as $row)
            <div class="modal fade" id="viewModal{{$row->unit_id}}" tabindex="-1" role="dialog"  aria-hidden="true">
                        ...
                        <div class="table-responsive ">
                           <table class="table row table-borderless">
                              <tbody class="col-lg-12 col-xl-12 p-0">
                                 ...
                                 <tr>
                                    <td><h6>Unit Name: </td><td> {{ $row->unit_name }}</h6></td>
                                 </tr>

                                 <tr>
                                    <td><h6>Unit Shotform: </td><td> {{ $row->unit_sf }}</h6></td>
                                 </tr>
...
function changeStatus(item_row_id)
{
  ...
  var stat = 0;
    ...
    $.ajax({
        type:"GET",
        url:"{{ url('admin/ajax/change-status/unit') }}?unit_id="+item_row_id ,
