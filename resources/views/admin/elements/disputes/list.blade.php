         ...
         <div class="card">
            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <td>
                           <button type="button" <?php  if($dispute->dispute_status == 1){ ?> disabled <?php } ?>class="btn btn-sm @if($dispute->dispute_status == '1') btn-success disabled @elseif($dispute->dispute_status == '2') btn-danger @else btn-warning @endif"
