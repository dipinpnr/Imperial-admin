      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="col-lg-12">
               ...
               @endif
                 <form action="{{route('store.store_attribute_value')}}"  method="POST" 
                  ...
                  <div class="row">
                     <div class="col-md-12">
                      ...
                      Add More</button>
                           ...
                           <input type="text" class="form-control" name="group_value[]" multiple="" value="{{old('group_value')}}" placeholder="Attribute Value">
                           </div>
                         </div>
                        </div>
