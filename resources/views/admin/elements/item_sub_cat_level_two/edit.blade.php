    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="col-lg-12">
          ...
          @endif
          <form action="{{ route('admin.update_iltsc',$sub_category_l_2->iltsc_id) }}" method="POST" enctype="multipart/form-data" >
            @csrf

            @if(isset($sub_category_l_2->iltsc_icon))
            <img class="m-2" src="{{asset('assets/uploads/category_icon/'.$sub_category_l_2->iltsc_icon)}}"  width="50" >
            @endif
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <select name="cat_id"  id="category" class="form-control"  >
                           ...
                           <option {{old('product_cat_id',$sub_category_l_2->item_category_id) == $key->item_category_id ? 'selected':''}} value="{{ @$key->item_category_id }}">{{ @$key->category_name }}</option>
                           @endforeach
                      </select>
                  </div>
               </div>
              ...
              <div class="col-md-4">
                    ...
                    <label class="form-label">Sub Category Level One *</label>
                     <select required class="form-control" name="item_sub_category_id" id="sub_category_id">
                        <option value="">Sub Category</option>
                           ...
                           <option {{old('item_sub_category_id',$sub_category_l_2->item_sub_category_id) == $key->item_sub_category_id ? 'selected':''}} value=" {{ $key->item_sub_category_id}} "> {{ $key->sub_category_name }}</option>
                           @endforeach
                     </select>
                  </div>
               </div> 
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input required type="text" class="form-control" name="iltsc_name" value="{{old('iltsc_name',$sub_category_l_2->iltsc_name)}}" placeholder="Sub Category">
                  </div>
               </div>
               ...
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <textarea  required class="form-control" id="iltsc_description" name="iltsc_description" rows="4" placeholder="Sub Category Description">{{old('iltsc_description',$sub_category_l_2->iltsc_description)}}</textarea>
                  </div>
                </div>
