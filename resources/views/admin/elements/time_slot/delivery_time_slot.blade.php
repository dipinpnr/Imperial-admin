              ...
              <div class="row">
                     ...
                     <table class="table">
                        ...
                        @endphp
                          ...
                          @foreach ($time_slots as $data)
                           ...
                           <tr id="{{@$i}}">
                            ...
                            <select required class="form-control" name="days[]" id="days[]">
                               @foreach($days as $day)
                      ...
                      <div class="form-group">
                        <center>
                        <a id="addDoc"  class="mb-2 btn btn-block  btn-red">Add Slot</a>
...
$(wrapper).append(' <tr id=""><td><span id="ss"></span><select required class="form-control" name="days[]" id="days"> @foreach($days as $day)<option value={{$day}}>{{$day}}</option>@endforeach</select></td><td><input required type="time" id="s"   class="form-control"   name="start[]"></td><td><span id="se{{@$i}}"></span><input type="time" id="e"  required   class="form-control"  name="end[]"></td><td><a id="r" class="remove_field btn btn-warning"><i style="color:red;" class="fa fa-trash"></i></a></td></tr>'); //add input box
