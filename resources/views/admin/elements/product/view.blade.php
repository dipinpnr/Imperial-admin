               ...
               <div class="tab-menu-heading">
                  <div class="tabs-menu1">
                     <ul class="nav">
                        ...
                        <li><a href="#tab-81" data-toggle="tab" class="">Branches</a></li>
                           ...
                           <table class="table row table-borderless">
                              <tbody class="col-lg-12 col-xl-6 p-0">
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                    <td><strong> Sub Category Level 2:</strong> {{@$product->sub_sub_category['sub_category_name']}}</td>
                                 </tr>
                                ...
                                <!--@endif-->
                                 ...
                                 <tr>
                                    <td><strong>Product Brand:</strong> {{ @$product->brand['brand_name']}}</td>
                                 </tr>
                              ...
                              <tbody class="col-lg-12 col-xl-6 p-0">
                               ...
                               <tr>
                                ...
                                <!--</tr>-->
                                 ...
                                 <tr>
                                     @if(!empty($product->product_base_image))
                                    <td>
                                        <strong>Image:</strong> <img data-toggle="modal" 
                                        data-target="#viewSingleProduct" 
                                        src="{{URL::to('/assets/uploads/products/base_product/base_image/'.$product->product_base_image)}}"  
                                        width="50" >
                                     </td>
                                      @endif
                                 </tr>
                             ...
                             <tbody class="col-lg-12 col-xl-6 p-0">
                                ...
                                @if(!$product_images->isEmpty())
                                 ...
                                 <tr>
                                    ...
                                    <td><img data-toggle="modal" data-target="#viewModal{{$product_image->product_image_id}}" src="{{URL::to('/assets/uploads/products/base_product/base_image/'.@$product_image->product_image)}}"  width="50" ></td>
                                    <td>
                                     ...
                                     <td><input type="checkbox"  @if (@$product_image->product_image == @$product->product_base_image) checked @endif disabled "></td>
                                    @endif
                                 </tr>
                           ...
                           <table  id="example" class="table table-striped table-bordered">
                              ...
                              @if(!$product_varients->isEmpty())
                                 ...
                                 <tr>
                                    ...
                                    <td><img  data-toggle="modal" data-target="#viewProductModal{{$value->product_varient_id}}" src="{{URL::to('/assets/uploads/products/base_product/base_image/'.@$value->product_varient_base_image)}}"  width="50" ></td>
                           ...
                           <table  id="example5" class="table table-striped table-bordered">
                             ...
                             <tbody class="col-lg-12 col-xl-6 p-0">
                                 ...
                                 <tr>
                                    ...
                                    @php
                                    $price = \DB::table('mst_branch_products')->where('global_product_id',$product->product_id)->where('branch_id',$branch->branch_id)->where('is_removed','!=',1)->first();
                                    @endphp
                                    
                                    <td>{{$price->product_price_offer}}</td>
                                 </tr>
                                  @endforeach
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          ...
          <img  src="{{URL::to('/assets/uploads/products/base_product/base_image/'.$product->product_varient_base_image)}}"  width="600" >
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          ...
          <img  src="{{URL::to('/assets/uploads/products/base_product/base_image/'.$product->product_image)}}"  width="600" >
