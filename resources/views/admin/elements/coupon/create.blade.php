                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" required class="form-control" id="valid_from" name="valid_from" value="{{old('valid_from')}}" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" required class="form-control" class="valid_to"  id="valid_to" name="valid_to" value="{{old('valid_to')}}" placeholder="">
                            </div>
                        </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select required=""  name="coupon_status"  class="form-control"  >
                                    ...
                                    <option  {{old('coupon_status') == '0' ? 'selected':''}} value="1">Active</option>
                                    <option  {{old('coupon_status') == '1' ? 'selected':''}} value="0">InActive</option>
                                </select>
                            </div>
                        </div>
