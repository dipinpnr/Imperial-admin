                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select required=""  name="coupon_status"  class="form-control"  >
                                    ...
                                    <option  {{old('coupon_status',$coupon->coupon_status) == '0' ? 'selected':''}} value="1">Active</option>
                                    <option  {{old('coupon_status',$coupon->coupon_status) == '1' ? 'selected':''}} value="0">InActive</option>
                                </select>
                            </div>
                        </div>
